...
class BirdCard {
  ...
  generateBirdCard() {
    // console.log(this)
    const answerCard = createEl('div', 'answer-container', 'gallery-container__card');
...
birdsData.forEach(block => {
  block.forEach(bird => {
    const card = new BirdCard(bird).generateBirdCard()
...
// async function drawGalery() {
//   await birdsData.forEach(block => {
//     block.forEach(bird => {
//       const card = new BirdCard(bird).generateBirdCard()
//       galleryContainer.append(card)
//     })
